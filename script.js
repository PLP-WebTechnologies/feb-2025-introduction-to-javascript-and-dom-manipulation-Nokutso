...
button.addEventListener("click", () => {
    ...
    greet.textContent = "HEY THERE, " + useName.toUpperCase(); //Changes text content dynamically.
    greet.style.fontSize = "2rem"; //Modifies CSS styles via JavaScript.
    section1.style.backgroundColor = "#A3C3D9";
    paragraph.textContent = "It’s so nice to meet you! I’m truly glad you’re here✨."

    form.remove(); //Adds or removes an element when a button is clicked.
